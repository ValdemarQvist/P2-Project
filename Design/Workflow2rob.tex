...
\node (pro1) [process, below of=dec1, yshift=-2cm] {Place the rotor in the balancing machine};
\node (stop) [startstop, below of=pro1, yshift=-0.5cm] {Balancing done};
...
\node (dec1) [decision, below of=start, yshift=-1.5cm] {Is the balancing machine empty?};
\node (pro1) [process, below of=dec1, yshift=-2cm] {Place the rotor in the balancing machine};
\node (dec2) [decision, below of=pro1, yshift=-2cm] {Is the balancing machine empty?};
\node (pro2) [process, below of=dec2, yshift=-2cm] {Place the rotor in the balancing machine};
\node (stop) [startstop, below of=pro2, yshift=-0.5cm] {Balancing done};
